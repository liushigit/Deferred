...
public struct Deferred<Value>: FutureType, PromiseType {
    ...
    private func upon(_ executor: ExecutorType, per flags: DispatchWorkItemFlags, execute body: (Value) -> Void) -> DispatchWorkItem {
    ...
    public func upon(_ executor: ExecutorType, body: (Value) -> Void) {
    ...
    public func wait(_ time: Timeout) -> Value? {
        ...
        let executor = QueueExecutor(.global(attributes: .qosUtility))
